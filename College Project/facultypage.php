...
<nav " style="background-color:#a8dfff;" class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div style="background-color:#a8dfff;" id="back" class="container-fluid">
            <a class="navbar-brand" href="index.html"><img style="height: 75px; width: 60px" src="img/logo2.png"></a><div id="title" style=" text-transform: uppercase; font-width=900%; font-size: 200%;"> St. Stephens College</div>
            <button class="navbar-toggler" type="button" data-toggler="collapse" data-targets="#navbarResponsive">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html/#tour">Tour</a>
                    </li>
                    <li class="nav-item">
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT, MHSSCE.";
